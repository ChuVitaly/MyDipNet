# Generated by Django 4.2.4 on 2023-08-30 19:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='auth_user', to='auth.group', verbose_name='Группы')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='auth_user', to='auth.permission', verbose_name='Права доступа')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='backend.user', verbose_name='Пользователь'),
        ),
        migrations.AddField(
            model_name='contact',
            name='user',
